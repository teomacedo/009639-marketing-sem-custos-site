...
use App\Models\CaseChamada; //editavel
use App\Http\Requests\Adm\Request_PainelCaseChamada; //editavel

class PainelCaseChamada extends Controller {

    public $dadosBase;

    public function __construct(CaseChamada $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/case-chamada';
    ...
    public function store(Request_PainelCaseChamada $request) {
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = CaseChamada::find($id);
    ...
    public function update(Request_PainelCaseChamada $request, $id) {
        $dataForm = $request->all();
