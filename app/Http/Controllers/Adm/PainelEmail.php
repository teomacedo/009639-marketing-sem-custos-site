...
use App\Models\Email; //editavel
use App\Http\Requests\Adm\Request_PainelEmail; //editavel

class PainelEmail extends Controller {
    public $dadosBase;

    public function __construct(Email $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/email';
        /* editavel */$this->dadosBase['tabelaColunas'] = ['Seq', 'E-mail'];
    ...
    public function store(Request_PainelEmail $request) {
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = Email::find($id);
    ...
    public function update(Request_PainelEmail $request, $id) {
        $dataForm = $request->all();
