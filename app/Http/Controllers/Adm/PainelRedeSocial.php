...
use App\Models\RedeSocial; //editavel
use App\Http\Requests\Adm\Request_PainelRedeSocial; //editavel

class PainelRedeSocial extends Controller {
    public $dadosBase;

    public function __construct(RedeSocial $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/rede-social';
    ...
    public function store(Request_PainelRedeSocial $request) {
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = RedeSocial::find($id);
    ...
    public function update(Request_PainelRedeSocial $request, $id) {
        $dataForm = $request->all();
