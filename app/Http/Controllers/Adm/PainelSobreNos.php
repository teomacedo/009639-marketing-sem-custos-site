...
use App\Models\SobreNos; //editavel
use App\Http\Requests\Adm\Request_PainelSobreNos; //editavel

class PainelSobreNos extends Controller {
    public $dadosBase;

    public function __construct(SobreNos $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/sobre-nos';
    ...
    public function index($foreign = '') {
        ...
        return view('adm.geral.list', compact(''))
                        ...
                        ->with('titulo', 'Trecho do conteúdo');
    }
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = SobreNos::find($id);
