...
use App\Models\ClienteChamada; //editavel
use App\Http\Requests\Adm\Request_PainelClienteChamada; //editavel

class PainelClienteChamada extends Controller {

    public $dadosBase;

    public function __construct(ClienteChamada $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/cliente-chamada';
        /* editavel */$this->dadosBase['tabelaColunas'] = ['Título'];
    ...
    public function store(Request_PainelClienteChamada $request) {
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = ClienteChamada::find($id);
    ...
    public function update(Request_PainelClienteChamada $request, $id) {
        $dataForm = $request->all();
