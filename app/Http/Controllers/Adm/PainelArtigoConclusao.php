...
use App\Models\ArtigoConclusao; //editavel
use App\Http\Requests\Adm\Request_PainelArtigoConclusao; //editavel

class PainelArtigoConclusao extends Controller {

    public $dadosBase;

    public function __construct(ArtigoConclusao $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/artigo-conclusao';
        /* editavel */$this->dadosBase['tabelaColunas'] = ['Título', 'Texto'];
    ...
    public function store(Request_PainelArtigoConclusao $request) {
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = ArtigoConclusao::find($id);
    ...
    public function update(Request_PainelArtigoConclusao $request, $id) {
        $dataForm = $request->all();
