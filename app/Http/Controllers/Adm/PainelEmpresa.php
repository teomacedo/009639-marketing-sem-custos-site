...
use App\Models\Empresa; //editavel
use App\Http\Requests\Adm\Request_PainelEmpresa; //editavel

class PainelEmpresa extends Controller {
    public $dadosBase;

    public function __construct(Empresa $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/empresa';
        /* editavel */$this->dadosBase['tabelaColunas'] = ['Nome', 'WhatsApp', 'Logo'];
        /* editavel */$this->dadosBase['imagem'] = ['active' => 'yes', 'label' => 'Logo'];
    ...
    public function store(Request_PainelEmpresa $request) {
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = Empresa::find($id);
    ...
    public function update(Request_PainelEmpresa $request, $id) {
        $dataForm = $request->all();
