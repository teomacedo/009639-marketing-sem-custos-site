...
use App\Models\Telefone; //editavel
use App\Http\Requests\Adm\Request_PainelTelefone; //editavel

class PainelTelefone extends Controller {
    public $dadosBase;

    public function __construct(Telefone $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/telefone';
        /* editavel */$this->dadosBase['tabelaColunas'] = ['Seq', 'Número', 'Icon'];
    ...
    public function store(Request_PainelTelefone $request) {
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = Telefone::find($id);
    ...
    public function update(Request_PainelTelefone $request, $id) {
        $dataForm = $request->all();
