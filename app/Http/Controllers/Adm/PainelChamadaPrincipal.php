...
use App\Models\ChamadaPrincipal; //editavel
use App\Http\Requests\Adm\Request_PainelChamadaPrincipal; //editavel

class PainelChamadaPrincipal extends Controller {

    public $dadosBase;

    public function __construct(ChamadaPrincipal $model) {
        /* editavel */$this->dadosBase['diretorio'] = '/adm/painel/chamada-principal';
        /* editavel */$this->dadosBase['tabelaColunas'] = ['Título', 'Subtítulo', 'Vídeo'];
    ...
    public function store(Request_PainelChamadaPrincipal $request) {
    ...
    public function edit($id, $foreign = '') {
        $this->dadosBase['model'] = ChamadaPrincipal::find($id);
    ...
    public function update(Request_PainelChamadaPrincipal $request, $id) {
        $dataForm = $request->all();
